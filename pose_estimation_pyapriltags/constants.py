...
CAMERA_CONSTANTS = {
    ...
    6: {
        "matrix":np.array([
        [1.9593597481549125e+03, 0.0, 6.1799452515097994e+02],
        [0.0, 1.9593597481549125e+03, 3.8821237404188537e+02],
        [0.0, 0.0, 1.0]
        ]),
        "distortion":np.array([
            [
            -6.5624579772676647e-02,
            -5.5970909408356639e-01,
            0,
            0,
            1.2465185525612805e+00
            ]
        ]),
        "yc": 0, #Y coordinate to center of robot. (meters I believe)
