...
CAMERA_CONSTANTS = {
    ...
    6: {
        "matrix":np.array([
        [1.9076899468373729e+03, 0.0, 6.7779527272579253e+02],
        [0.0, 1.9076899468373729e+03, 3.9244457610203904e+02],
        [0.0, 0.0, 1.0]
        ]),
        "distortion":np.array([
            [
            -6.1991651186047485e-02,
            -4.0350446931532596e-01,
            0,
            0,
            6.6454531169128039e-01
            ]
        ]),
        "yc": 0, #Y coordinate to center of robot. (meters I believe)
        "xc": 0, #X coordinate to center of robot. (meters I believe)
