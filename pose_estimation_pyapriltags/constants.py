...
CAMERA_CONSTANTS = {
    ...
    6: {
        "matrix":np.array([
        [4.2084481349726675e+03, 0.0, 6.9849714847459882e+02],
        [0.0, 4.2084481349726675e+03, 4.4616852282765370e+02],
        [0.0, 0.0, 1.0]
        ]),
        "distortion":np.array([
            [
            -1.3196663156751259e-01,
            3.0221065926845800e+00,
            0,
            0,
            -5.1041579455996576e+01
            ]
        ]),
        "yc": 0, #Y coordinate to center of robot. (meters I believe)
